...
For `advise` and `direction`, always name the markdown file at call time with `-o`. Use a readable filename that explains the artifact, such as `accounts-filter-advice.md`, `museon-home-art-direction.md`, or `pricing-page-design-imagery.md`.
...
gemini-designer advise "判断这个页面是否符合项目现有视觉风格，并给出具体优化建议" \
  ...
  -o ./outputs/gemini-designer/design-page-advice.md
```
...
gemini-designer advise "结合截图判断这个页面哪里最影响视觉完成度" \
  ...
  -o ./outputs/gemini-designer/current-page-screenshot-advice.md

gemini-designer direction "参考这张图，提炼更适合产品的设计意象 markdown" \
  -i ./references/moodboard.png \
  -o ./outputs/gemini-designer/product-design-imagery.md
```
...
```bash
gemini-designer advise "给这个设计规范页提视觉优化建议" -f ./design.html -o ./outputs/gemini-designer/design-page-advice.md
gemini-designer advise "结合截图给这个页面提视觉优化建议" -f ./design.html -i ./screenshots/current.png -o ./outputs/gemini-designer/page-screenshot-advice.md
gemini-designer direction "给这个产品生成设计意象 markdown" -o ./outputs/gemini-designer/product-design-imagery.md
gemini-designer direction "基于这个页面提炼更强的视觉意象" -f ./design.html -o ./outputs/gemini-designer/page-design-imagery.md
...
gemini-designer direction \
  ...
  -o ./outputs/gemini-designer/product-art-direction.md
```
